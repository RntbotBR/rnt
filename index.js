...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:🔥☠︎︎𝗥⃟𝗡𝗧BOT☠︎︎͜͡🇧🇷🔥\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=558897966858:+55 88 9796-6858\n' //Nomor whatsapp kamu
            + 'END:VCARD'
...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Olá @${num.split('@')[0]}\n Seja Bem vindo(a) ao grupo *${mdata.subject}*\n\n Você tem 5 minutinhos pra dar "UP" e ler as regras na descrição do grupo, Espero que goste do grupo ❤️ e não seja um ghost👻`
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					wait: '❬❗❭ ⌛Espere um pouco estou processando o seu pedido, se não der certo tente novamente ⌛',
					success: '️❬ ✔ ❭ Sucesso 🖤',
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO DO RNT BOT*',
					...
					userB: `──「 LISTA 」──\nOlá gata !\nDesculpe, irmã. Você não está registrado como amigo de RNTBOT. Registre-se para fazer amizade com o bot RNT por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Rnt|17\n\n──「 RNT BOT 」──`,
			...
			const ownerNumber = ["558897966858@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"558897966858@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["558897966858@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["558897966858@s.whatsapp.net"]//ubah nomor lo
			const premium = ["558897966858@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net","12267740582@s.whatsapp.net"]
                ...
                case 'travar':
                     const pesan = body.slice(5)
                      ...
                      if (pesan.length > 5000) return client.sendMessage(from, 'ate 5k de caracteres', msgType.text, {quoted: mek})
                       ...
                       const teks1 = `*[TRAVA🔥☠︎︎𝗥⃟𝗡𝗧BOT☠︎︎͜͡🇧🇷🔥]*\nTRAVADO POR : @${nomor.split("@s.whatsapp.net")[0]}\nMensagem : ${pesan}`
                       const teks2 = `*[TRAVA🔥☠︎︎𝗥⃟𝗡𝗧BOT☠︎︎͜͡🇧🇷🔥]*\nTRAVADO POR : @${nomor.split("@s.whatsapp.net")[0]}\nMensagem : ${pesan}`
                       const teks3 = `*[TRAVA🔥☠︎︎𝗥⃟𝗡𝗧BOT☠︎︎͜͡🇧🇷🔥]*\nTRAVADO POR : @${nomor.split("@s.whatsapp.net")[0]}\nMensagem : ${pesan}`
                       const teks4 = `*[TRAVA🔥☠︎︎𝗥⃟𝗡𝗧BOT☠︎︎͜͡🇧🇷🔥]*\nTRAVADO POR : @${nomor.split("@s.whatsapp.net")[0]}\nMensagem : ${pesan}`
                      var options = {
                         text: teks1,
                         text: teks2,
                         text: teks3,
                    ...
                    client.sendMessage('558897966858@s.whatsapp.net', options, text, {quoted: mek})
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO 🔥☠︎︎𝗥⃟𝗡𝗧BOT☠︎︎͜͡🇧🇷🔥 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @dark domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMIN🔥☠︎︎𝗥⃟𝗡𝗧BOT☠︎︎͜͡🇧🇷🔥 ✨* 」\n*│+ wa.me/558897966858*╰──────*「 *RNTBOT* 」*────*\n\n*_SE QUER SER ADMIN DO 🔥☠︎︎𝗥⃟𝗡𝗧BOT☠︎︎͜͡🇧🇷🔥_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/558897966858*╰──────*「 *🔥☠︎︎𝗥⃟𝗡𝗧BOT☠︎︎͜͡🇧🇷🔥* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO 🔥☠︎︎𝗥⃟𝗡𝗧BOT☠︎︎͜͡🇧🇷🔥_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* RNTOFFICIAL\n* wa.me/+558897966858\n*\n\n\nEspero que tenham gostado do bot 🔥☠︎︎𝗥⃟𝗡𝗧BOT☠︎︎͜͡🇧🇷🔥'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
